 ...
 *
 *   $Id: kb_header.php,v 1.7 2004/01/11 16:45:52 jonohlsson Exp $
 *
 *
 ***************************************************************************/
...
if ( ( $kb_config['allow_new'] == ALLOW_NEW && $userdata['session_logged_in'] && $show_new ) || ( $kb_config['allow_new'] == ALLOW_NEW && $kb_config['allow_anon'] == ALLOW_ANON && $show_new ) || $is_admin && $show_new )
{
   ...
   {
       $temp_url = append_sid(this_kb_mxurl("mode=add&cat=" . $HTTP_GET_VARS['cat']));
...
$temp_url = append_sid($module_root_path . "kb_search.php");
