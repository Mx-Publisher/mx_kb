 ...
 * -------------------------------------------------------------------------
 * 
 *    $Id: lang_admin.php,v 1.1 2005/12/08 15:04:26 jonohlsson Exp $
 */
...
$lang['Panel_config_explain'] = 'Change the configuration of your Knowledge Base';
	...
	$lang['Wysiwyg_path_explain'] = 'This is the path (from mxBB/phpBB root) to the WYSIWYG software folder, eg \'modules/\' if you have uploaded, for example, TinyMCE in modules/tinymce.';
